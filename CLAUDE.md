...
This configuration was generated by [VibeSOP](https://github.com/nehcuh/vibesop-py) - A Skill Operating System (SkillOS) for AI-assisted development.
...
VibeSOP provides built-in quick commands for common tasks. When the user's query starts with `/vibe-`, you MUST call `vibe route --slash` to handle it:

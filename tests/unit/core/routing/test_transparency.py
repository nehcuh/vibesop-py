...
class TestRoutingTransparency:
    ...
    def test_route_returns_layer_details(self) -> None:
    ...
    def test_orchestrate_returns_layer_details(self) -> None:
    ...
    def test_alternatives_available_without_explain(self) -> None:
    ...
    def test_alternatives_deduplicated(self) -> None:
    ...
    def test_empty_layer_details_returns_empty_alternatives(self) -> None:
    ...
    def test_route_populates_alternatives_from_rejected(self) -> None:

...
class TestOrchestrateAsDefault:
    ...
    def test_single_intent_returns_single_mode(self, tmp_path):
    ...
    def test_orchestrated_result_has_fallback(self, tmp_path):
    ...
    def test_orchestration_disabled_falls_back(self, tmp_path):

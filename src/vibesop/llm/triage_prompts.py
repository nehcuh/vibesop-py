...
class TriagePromptRegistry:
    ...
    VERSIONS: ClassVar[dict[str, str]] = {
        "v1": (
            ...
            "5. Session end signals ('that's all for now', 'heading out', 'I'm done', '我要离开了') → builtin/session-end\n\n"
            "User request: {query}\n\n"
            "Available skills:\n{skills_summary}\n\n"
        ...
        "v2": (
            ...
            "6. Session end signals ('that's all for now', 'heading out', 'I'm done', '我要离开了') → builtin/session-end\n\n"
            "User request: {query}\n\n"
            "Available skills:\n{skills_summary}\n\n"

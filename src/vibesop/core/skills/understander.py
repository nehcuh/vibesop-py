...
"""Skill auto-understanding and configuration module."""
...
class CategoryRules:
    ...
    @classmethod
    def infer_category(cls, metadata: SkillSpec, content: str = "") -> str:
...
class SkillAutoConfigurator:
    ...
    def understand_and_configure(
        self, metadata: SkillSpec, skill_content: str, scope: str = "project"
    ) -> AutoGeneratedConfig:
        ...
        # Step 2: 应用规则生成配置
        config = self.generate_config(metadata, analysis, scope)
    ...
    def _analyze_skill(self, metadata: SkillSpec, content: str) -> SkillAnalysis:
        analysis = SkillAnalysis()
    ...
    def generate_config(
        self, metadata: SkillSpec, analysis: SkillAnalysis, scope: str
    ) -> AutoGeneratedConfig:
    ...
    def _calculate_priority(self, metadata: SkillSpec, analysis: SkillAnalysis) -> int:
        priority = 50

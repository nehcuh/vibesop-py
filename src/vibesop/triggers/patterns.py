...
DEV_PATTERNS = [
    ...
    TriggerPattern(
        ...
        category=PatternCategory.DEV,
        keywords=["test", "testing", "run", "execute", "测试", "运行"],
        regex_patterns=[
            r"run.*tests?",
            r"execute.*tests?",
            r"test.*suite",
...
DOCS_PATTERNS = [
    ...
    TriggerPattern(
        ...
        category=PatternCategory.DOCS,
        keywords=["update", "docs", "documentation", "refresh", "modify", "更新", "文档", "刷新"],
        regex_patterns=[
    ...
    TriggerPattern(
        ...
        category=PatternCategory.DOCS,
        keywords=["format", "style", "prettify", "格式化", "文档"],
        regex_patterns=[
    ...
    TriggerPattern(
        ...
        category=PatternCategory.DOCS,
        keywords=["api", "reference", "swagger", "openapi", "API文档", "接口文档"],
        regex_patterns=[
            r"generate.*api.*docs",
    ...
    TriggerPattern(
        ...
        category=PatternCategory.DOCS,
        keywords=["changelog", "release", "notes", "version", "变更日志"],
        regex_patterns=[
...
PROJECT_PATTERNS = [
    ...
    TriggerPattern(
        ...
        category=PatternCategory.PROJECT,
        keywords=["migrate", "migration", "move", "transfer", "迁移", "转移", "搬家"],
        regex_patterns=[
            r"migrate.*project",
            r"project.*migration",
            r"迁移.*项目",
    ...
    TriggerPattern(
        ...
        category=PatternCategory.PROJECT,
        keywords=["upgrade", "update", "bump", "升级", "更新版本"],
        regex_patterns=[
            r"upgrade.*project",
    ...
    TriggerPattern(
        ...
        category=PatternCategory.PROJECT,
        keywords=["clean", "purge", "remove", "清理"],
        regex_patterns=[
            r"clean.*project",
            r"purge.*project",
    ...
    TriggerPattern(
        ...
        category=PatternCategory.PROJECT,
        keywords=["status", "check", "health", "info", "状态", "健康", "信息"],
        regex_patterns=[
...
DEFAULT_PATTERNS = (
    SECURITY_PATTERNS + CONFIG_PATTERNS + DEV_PATTERNS + DOCS_PATTERNS + PROJECT_PATTERNS
)

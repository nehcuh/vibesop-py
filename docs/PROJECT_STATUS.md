...
| 本分支 8.4.0 候选 | 双向路由评测、near_miss 负例、no-match 聚合、decision_source 注册表、全量 tracked markdown 产物引用守卫（1109 refs / 0 dangling / 468 stale occurrences across 460 keys）；详见路线图 | 本分支实现即 8.4.0 已发布；评测数字即可靠性证明 |

...
- **想装技能**：[`SKILLS_GUIDE.md`](SKILLS_GUIDE.md) 详解 19 个内置技能 + 社区技能包
...
- **想看路线图**：[`ROADMAP.md`](ROADMAP.md)（当前源码 8.5.0 source candidate；历史稿 [archive/roadmap-through-8.3.md](archive/roadmap-through-8.3.md)）

...
Path(__file__).with_name('runner-self-check.json').write_text(json.dumps({'offline_only':True,'passed':True,'checks':checks},indent=2))
print('Offline runner checks passed. Not experimental results.')

...
- **Want to install skills**: [`SKILLS_GUIDE.md`](SKILLS_GUIDE.md) details 19 built-in skills + community packs
...
- **Want the roadmap**: [`ROADMAP.md`](ROADMAP.md) (public 8.3.0 / unreleased 8.4.0 candidate; historical copy [archive/roadmap-through-8.3.md](archive/roadmap-through-8.3.md))

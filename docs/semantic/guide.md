...
VibeSOP-Py introduced true semantic understanding capabilities in v2.1 (now at 8.4.0), moving beyond TF-IDF keyword matching to actual comprehension of meaning.
